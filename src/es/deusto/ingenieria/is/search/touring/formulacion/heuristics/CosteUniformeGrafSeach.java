...
public class CosteUniformeGrafSeach  extends SearchMethod{
		 ...
		 */
		private static CosteUniformeGrafSeach instance;
		
		/**
		 * Constructor method is private in accordance with the pattern <b>Singleton</b>
		 */
		private CosteUniformeGrafSeach () {		
		}
		 ...
		 */
		public static CosteUniformeGrafSeach getInstance() {
			if (instance == null) {
				instance = new CosteUniformeGrafSeach ();
			}
